...
set JARPATH=%APP_HOME%\lib\VOYAGER_BE-0.0.1-SNAPSHOT.jar

@rem Execute VOYAGER_BE
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %VOYAGER_BE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%VOYAGER_BE_EXIT_CONSOLE%" exit 1
exit /b 1
